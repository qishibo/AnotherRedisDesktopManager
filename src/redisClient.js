...
export default {
  ...
  createSSHConnection(sshOptions, host, port, auth, config) {
    const sshConfig = {
      ...
      algorithms: {
        cipher: ['aes128-gcm', 'aes128-gcm@openssh.com', 'aes256-gcm', 'aes256-gcm@openssh.com', 'aes128-ctr', 'aes192-ctr', 'aes256-ctr', 'chacha20-poly1305@openssh.com', '3des-cbc', 'aes256-cbc', 'aes192-cbc', 'aes128-cbc', 'arcfour256', 'arcfour128', 'arcfour', 'blowfish-cbc', 'cast128-cbc'],
