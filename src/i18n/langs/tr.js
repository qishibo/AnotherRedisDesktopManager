const tr = {
  message: {
    ...
    click_enter_to_rename: 'Yeniden adlandırma izin verildiğinde, tıklayarak veya Enter tuşuna basarak yeniden adlandırılabilir',
    switch_enable_rename: 'Yeniden adlandırma izin ver/ yasaklama',
