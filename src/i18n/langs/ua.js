const ua = {
  message: {
    ...
    load_all_keys_tip: 'Завантажте всі ключі одночасно. Якщо кількість ключів занадто велика, клієнт може застрягти або навіть вийти з ладу. Будь ласка, використовуйте його правильно',
