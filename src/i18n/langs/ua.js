const ua = {
  message: {
    ...
    click_enter_to_rename: 'Після того, як перейменування буде дозволено, ви можете перейменувати його, натиснувши або натиснувши Enter',
    switch_enable_rename: 'Дозволити/заборонити перейменування',
