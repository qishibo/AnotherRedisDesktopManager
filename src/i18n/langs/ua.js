const ua = {
  message: {
    ...
    update_downloaded:
      'Оновлення завершено, запустіть програму, будь ласка.\
    ...
    mac_not_support_auto_update:
      'MacOS не підтримує автоматичне оновлення, <a href="https://github.com/qishibo/AnotherRedisDesktopManager/releases">скачайте</a> і перевстановіть додаток вручну, \
    ...
    font_faq:
      '1. Можна встановити кілька шрифтів. <br>\
    ...
    private_key_faq:
      'В даний час підтримуються закриті RSA ключі, що починаються з <pre> ----- BEGIN RSA PRIVATE KEY ----- </ pre> \
    ...
    confirm_modify_unvisible_content:
      'Вміст містить невидимі символи, ви можете безпечно редагувати їх у "Hex View". Якщо продовження редагування у "Text View" може спричинити помилки кодування, впевнено продовжувати?',
    ...
    command_log: 'Журнал',
    sentinel_faq:
      'Ви можете вибрати один із декількох сторожових. Будь ласка, заповніть конфігурацію сторожової адреси, порту та пароля. Пароль вузла Redis - це пароль головного вузла, який контролює сторожовий.',
    ...
    load_all_keys_tip:
      'Завантажте всі ключі одночасно. Якщо кількість ключів занадто велика, клієнт може застрягти. Будь ласка, використовуйте його правильно',
    tree_node_overflow:
      'Занадто багато ключів або папок, тільки {num} дисплея. Якщо ваш ключ не тут, рекомендується використовувати нечіткий пошук, або встановити роздільник для поширення ключів у теки',
    ...
    before_connect: 'Перед підключенням (команда)',
    before_connect_error: 'Помилка перед підключенням (команда): {message}',
  },
};
