const fr = {
  message: {
    ...
    sentinel_faq:
      "Vous pouvez choisir l'une des plusieurs sentinelles. Veuillez remplir la configuration de la sentinelle pour l'adresse, le port et le mot de passe. Le mot de passe du nœud Redis est le mot de passe du nœud maître surveillé par la sentinelle.",
    ...
    load_all_keys_tip:
      "Chargez toutes les clés en même temps. Si le nombre de clés est trop important, le client peut rester bloqué. Veuillez l'utiliser correctement",
    tree_node_overflow:
      "Il y a trop de touches ou de dossiers, ne laissant que {num} à afficher. Si votre clé n'est pas ici, une recherche floue est recommandée, ou définissez un séparateur pour disperser la clé dans le dossier",
