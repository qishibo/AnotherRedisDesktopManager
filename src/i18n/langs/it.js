const it = {
  message: {
    ...
    click_enter_to_rename: 'Per consentire la ridenominazione è possibile fare clic o premere Invio dopo averla rinominata',
    switch_enable_rename: 'È consentita/vietata la ridenominazione',
