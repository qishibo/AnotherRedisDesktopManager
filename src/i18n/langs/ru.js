const ru = {
  message: {
    ...
    password: 'Пароль',
    connection_name: 'Произвольное имя',
    ...
    load_all_keys_tip: 'Загрузите все ключи одновременно. Если количество ключей слишком велико, клиент может зависнуть или даже вылететь. Пожалуйста, используйте его правильно',
