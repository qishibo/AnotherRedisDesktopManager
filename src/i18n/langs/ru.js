const ru = {
  message: {
    ...
    click_enter_to_rename: 'Переименование разрешено, переименование может быть произведено нажатием или нажатием клавиши ENTER',
    switch_enable_rename: 'Переименование разрешено/запрещено',
