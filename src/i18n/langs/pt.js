const pt = {
  message: {
    ...
    click_enter_to_rename: 'Para permitir a mudança de nome, basta clicar ou premir Enter após a mudança de nome',
    switch_enable_rename: 'Permitir/proibir renomear',
